...
print('\n\t\tEdited train dataset:\n\n', train.head())

# call tokenizer
# train
train_tokenizer = Tokenizer(num_words=2815, filters='None', lower=True)
train_tokenizer.fit_on_texts(train)
# test
test_tokenizer = Tokenizer(num_words=1250, filters='None', lower=True)
